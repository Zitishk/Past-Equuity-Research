...
### Background: Who Are Teruko Utsumi and Masakazu Watanabe?

Lapin Track is a two-founder studio, which is unusual for the Japanese indie anime space where most small studios are built around a single producer or director figure.

**Teruko Utsumi** came from the screenwriting/series composition side. Her key credit before founding Lapin Track was *Durarara!!* (2010, Brain's Base) — a critically acclaimed urban fantasy series that became a defining title of the early 2010s anime boom. Brain's Base at the time was one of the more respected mid-size studios in Japan, and *Durarara!!* was its breakout hit. Utsumi's series composition credit on that show established her name within the industry.

**Masakazu Watanabe** came from the production/line producer side. He worked at Brain's Base and then briefly at MAPPA (2012–2014, MAPPA's very early years when it was still establishing itself post-Madhouse). The Brain's Base → MAPPA career path is significant: it means Watanabe had direct exposure to how a studio gets founded and scales from scratch, having been at MAPPA during the period when Manabu Otsuki was building it.

Both left their respective positions to co-found Lapin Track in mid-2014.
...
- **Date:** June 30, 2014
- **Location:** Nishi-Ogikubo, Tokyo — a quiet residential area in Suginami Ward, notably the same general neighbourhood cluster as several other small studios (Suginami has historically high density of animation production companies)
- **Legal structure:** Godo Kaisha (GK) — a Japanese LLC, not a KK joint-stock company. This is a meaningful distinction: GK has lower setup costs, simpler governance, and is typical for small creative partnerships where two founders want equal say without complex shareholder mechanics.
- **Initial investment:** Not publicly disclosed. No reported external funding. Likely personal savings + advance payments from first contracted work.
- **Initial headcount:** Not on record. Given LLC structure and subcontract-first model, estimated 2–5 people at launch.

---

### First Work: *Yuri Kuma Arashi* (January 2015)

- **Title:** *Yuri Kuma Arashi* (English: *Yurikuma Arashi* / *Love Bullets Yurikuma Arashi*)
- **Type:** 12-episode TV anime series
- **Director:** Kunihiko Ikuhara
- **Air date:** January 2015 — approximately 6 months after Lapin Track's founding
- **Production structure:** Co-production with Silver Link (Silver Link as lead studio, Lapin Track in a support/co-production role)
- **How they got it:** This requires understanding the Brain's Base connection. Ikuhara had worked with Brain's Base on *Mawaru Penguindrum* (2011) — one of the most discussed anime of that year, a critical darling. Utsumi and Watanabe were Brain's Base alumni. When Ikuhara began developing *Yuri Kuma Arashi*, the existing professional relationship created a natural path to involvement. Lapin Track did not cold-pitch this; they were known quantities to the production.
- **Lapin Track's role:** Co-production support, not lead studio. Silver Link handled primary production. This is standard for a studio that is 6 months old — you do not walk into a full lead production immediately.
- **Revenue from this:** Co-production fees (not disclosed). Sufficient to keep the studio operational.

---

### The Support Work Years (2015–2021)

Lapin Track's first several years followed the classic small-studio playbook: take subcontract and support work from larger productions while slowly building toward original output.

**Documented support credits:**

- *Endride* (2016) — co-production with Brain's Base (again, the alumni network paying dividends)
- *Sarazanmai* (2019) — Ikuhara's next project, this time co-produced with MAPPA. Lapin Track again involved through the Ikuhara relationship. Watanabe's MAPPA background also relevant here.
- *Aharen-san wa Hakarenai* (2022) — key animation support
- *Akiba Maid War* (2022) — key animation support (P.A. Works lead)

The pattern is consistent: Brain's Base alumni network + Ikuhara relationship + Watanabe's MAPPA connections = a reliable pipeline of subcontract work that kept the studio alive without needing to win open-market pitches.

---

### First Own OVA: *Onna no Sono no Hoshi* (December 8, 2022)

- **Title:** *Onna no Sono no Hoshi* (English: *The Girl in the Arcade*)
- **Type:** OVA bundled with limited edition of manga volume 3
- **Release:** December 8, 2022
- **Significance:** This was Lapin Track's first production as lead studio on an original OVA — approximately 8 years after founding. That timeline is not unusual for a small Japanese studio; the subcontract-first model means lead production comes slowly.
- **Revenue model:** Manga-bundled OVA is a specific business model in Japanese publishing — the publisher (in this case the manga publisher) funds the OVA as a promotional tool to drive sales of the limited-edition volume. The studio receives a flat production fee. Revenue is modest but risk is near-zero: the publisher carries the commercial risk, the studio just executes.

---

### First Lead TV Series: *Undead Girl Murder Farce* (2023)

- **Title:** *Undead Girl Murder Farce*
- **Type:** 13-episode TV series
- **Air date:** Summer 2023
- **Source material:** Light novel series
- **Significance:** First time Lapin Track was lead studio on a full-length TV series — 9 years after founding
- **Subsequent lead titles:** *SHOSHIMIN: How to Become Ordinary* (2024), *You and I Are Polar Opposites* (2026)

The gap between founding (2014) and first lead TV (2023) is stark but instructive: this is what the subcontract survival model looks like in practice. You spend the first decade staying alive; you spend the second decade building a slate.

---

### Cash Burn and Revenue

**Not publicly available.** LLC financial statements in Japan are not required to be publicly filed. No interviews contain specific figures.

Reasonable inference from operational history:
- Co-production fees from *Yuri Kuma Arashi* (2015) and *Endride* (2016) = early revenue baseline
- *Sarazanmai* (2019) involvement = continued subcontract income
- Key animation work on *Aharen-san* and *Akiba Maid War* (2022) = near-continuous work pipeline
- Studio has never reported financial distress; no near-closure events in public record
- Cost structure: Small team, LLC structure, Nishi-Ogikubo location (not premium) — lean fixed costs

---

### When Did Lapin Track Turn Profitable?

**Unknown.** No data available. The studio has operated continuously for 12 years without reported financial distress, suggesting it has at minimum covered costs throughout. Whether it has generated distributable profit beyond covering principals' salaries is not on record.
...
| Year | Event |
|------|-------|
| 2010 | Utsumi works on *Durarara!!* at Brain's Base |
| 2011 | Brain's Base co-produces *Mawaru Penguindrum* with Ikuhara |
| 2012–2014 | Watanabe works at MAPPA during its founding years |
| Jun 2014 | Lapin Track founded (GK/LLC), Nishi-Ogikubo, Tokyo |
| Jan 2015 | *Yuri Kuma Arashi* — first production credit (co-production, Silver Link lead) |
| 2016 | *Endride* co-production with Brain's Base |
| 2019 | *Sarazanmai* co-production with MAPPA / Ikuhara |
| 2022 | Key animation: *Aharen-san wa Hakarenai*, *Akiba Maid War* |
| Dec 2022 | *Onna no Sono no Hoshi* OVA — first lead OVA credit |
| 2023 | *Undead Girl Murder Farce* — first lead TV series (9 years after founding) |
| 2024 | *SHOSHIMIN: How to Become Ordinary* |
| 2026 | *You and I Are Polar Opposites* |
...
- **Cash burn / operating costs:** Never disclosed; LLC files privately
- **Deal terms for any co-production:** Not public
- **Exact headcount at any point:** Not on record
- **First-profit date:** Unknown
- **Salary/compensation of founders:** Not disclosed
